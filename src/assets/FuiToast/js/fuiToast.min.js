!(function (t, s) {
  ...
  `,
    ...
    class r {
      ...
      #h = (s) => {
        ...
        if (
          ...
          let e = i.querySelector(".fui-toast-box");
          Object.assign(e.style, s.style);
        }
        if ((this.#l(s, i), s.isClose)) {
          let o = i.querySelector(".fui-toast-close");
          o.onclick = () => {
      ...
      #m = (t) => {
        let s = this.#a?.querySelector(`[data-id="${t}"]`);
        return s;
      };
      #i = () => {
        let t = 0;
      ...
      #j = (t) => {
        let s = 0 !== this.#d.length;
        if (
          (s && (this.#d.forEach((t) => t && clearTimeout(t)), (this.#d = [])),
          t)
        )
          return this;
        let i = Date.now(),
          e = this.#b.map((t) => {
            ...
            let s = (t.duration || 0) + t.pauseDuration - (i - t.createdAt);
            return s < 0
              ? (this.dismiss(t.id), null)
              : setTimeout(() => this.dismiss(t.id), s);
          });
      ...
      #o = () => {
        ...
        return (
          (this.#b = this.#b.map((t) => ({
            ...t,
            pauseDuration: t.pauseDuration + s,
          }))),
          (this.#c = void 0),
          this.#j(this.#c),
          this
    ...
    return (
      ...
      (c.warning = u("warning")),
      (c.loading = u("loading")),
      (c.close = (t) => l.closeToast(t)),
      (c.promise = (t, s, i) => {
        let e = c.loading(s.loading, { duration: 1 / 0, ...i, ...i?.loading });
        return (
          t
            .then(
              (t) => (
                c.success(n(s.success, t), {
                  id: e,
                  duration: 3e3,
                  ...i,
                  ...i?.success,
